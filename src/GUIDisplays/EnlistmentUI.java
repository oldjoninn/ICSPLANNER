               ...
               if (empty) {
                   ...
                   addButton.setOnAction(e -> {
                       ...
                       if (selectedCourse != null) {
                           ...
                           // Check if course is offered in student's degree
                           ...
                           // Auto-add the corresponding lecture
                           ...
                           if (lectureCourse != null) {
                               ...
                               if (!lectureAlreadyEnrolled) {
                                   ...
                                   System.out.println("Auto-added lecture: " + lectureCourse.getCourseID() + " - " + lectureCourse.getSection());
                               }
                           }}
