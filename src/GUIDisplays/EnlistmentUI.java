...
public class EnlistmentUI {
   ...
   public Scene EnlistScreen(Stage primaryStage) {
       ...
       searchButton.setOnAction(e -> {
           ...
           if (foundCount == 0) {
               showErrorPopup("","No courses found course code: " + courseCode);
           }
       });
       root.getChildren().addAll(searchField, searchButton, availableLabel, availableTable, enlistedLabel, plannedTable);
