...
import components.*; // Import your components
...
public class Main extends Application {
   ...
   public void start(Stage primaryStage) {
       ...
       try {
           ...
           if (cssUrl != null) {
               ...
               System.out.println("CSS not found at /application/application.css");
           }
       ...
       // Calculate positions AFTER stage is shown
   ...
   private void displayMain(Pane root, Stage primaryStage) {
       ...
       Home.setOnAction(e -> {
           ...
           // Close any open popups (Login/Register)
   ...
   private static void loadDegreePrograms() {
       ...
       bscs.loadCourses(); mscs.loadCourses(); mit.loadCourses(); phd.loadCourses();
